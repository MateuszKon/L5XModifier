...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.widgets.btn_rungGenerator.clicked.connect(self.buttonClick)
        ...
        # ///////////////////////////////////////////////////////////////
        self.widgets.stackedWidget.setCurrentWidget(self.widgets.page_rungGenerator)
    ...
    def buttonClick(self):
        ...
        if btnName == "btn_rungGenerator":
            ...
            UIFunctions.resetStyle(self, btnName)
            btn.setStyleSheet(UIFunctions.selectMenu(btn.styleSheet()))
            self.widgets.titleRightInfo.setText('L5X Modifier - Rung Generator')
